# nexflow.it — Landing Copy Deck

> Source of truth: `BRAND.md → Messaging`. EN original; DE crafted adaptation
> (Core Lexicon). Voice: warm, personal, conversational, first person ("I've
> prepared your briefing") — "pen on paper." Audience: knowledge workers, project
> teams, founders, ops/marketing/research. Pillar order: 1 → 2 → 3.
>
> Note: the hero tagline ("From 'someday' to done.") and the subhead ("You think
> it through. Your agents see it through.") are BOTH kept — a later A/B test
> decides which leads.

## Hero

- **Tagline (EN):** From 'someday' to done.
- **Tagline (DE):** Aus 'irgendwann' wird erledigt.
- **Subhead (EN):** You think it through. Your agents see it through.
- **Subhead (DE):** Du denkst es durch. Deine Agenten ziehen es durch.
- **Primary CTA (EN / DE):** Start your first project / Starte dein erstes Projekt

## Positioning

**EN:** You think, brainstorm, and decide; your agents carry the project forward. nexflow.it turns your thinking into done work — like a personal chief of staff who prepares your day, keeps the thread, and makes sure nothing slips.

**DE:** Du denkst, brainstormst und entscheidest; deine Agenten tragen das Projekt voran. nexflow.it macht aus deinem Denken erledigte Arbeit — wie ein persönlicher Chief of Staff, der deinen Tag vorbereitet, den Faden hält und dafür sorgt, dass nichts liegen bleibt.
